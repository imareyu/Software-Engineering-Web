...
<div class="container">
    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            <form action="${pageContext.request.contextPath}/user/deleteTea" method="post">
                ...
                <div class="form-group">
                    <label>提示信息:</label>
                    <label style="color: red">注意：删除教师用户请先确认此教师<label style="font-weight: 700">名下没有队伍</label>，否则无法删除</label>
                </div>
