...
<html>
<head>
    <%--管理员用户使用，为了前往删除教师用户界面--%>
    <title>查询教师用户界面</title>
...
<div class="container">
    ...
    <div class="row clearfix">
        ...
        <div class="col-md-5 column">
            <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/user/queryTea_forDeleteTea_ad" method="post">
